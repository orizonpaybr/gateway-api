...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::table('adquirentes', function (Blueprint $table) {
            ...
            $table->boolean('is_default_card_billet')->default(0);
        });

        // Adicionar novos campos na tabela users
        Schema::table('users', function (Blueprint $table) {
            // Adicionar campo para adquirente específica de Cartão+Boleto
            $table->string('preferred_adquirente_card_billet')->nullable();
            $table->boolean('adquirente_card_billet_override')->default(0);
        });
    }
