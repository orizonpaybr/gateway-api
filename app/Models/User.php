...
class User extends Authenticatable
{
        ...
        protected function casts(): array
    {
        return [
            ...
            'login_lockout_tier' => 'integer',
            'login_lockout_final_chance' => 'boolean',
    ...
    public function gerarCodigoAffiliate(): string
    {
        if (!$this->affiliate_code) {
            ...
            $this->affiliate_link = config('app.affiliado_url') . '/cadastro?ref=' . $this->affiliate_code;
            $this->save();
        }
