...
class ListWebhookLogs extends Command
{
    ...
    public function handle(): int
    {
        ...
        $this->line('  grep "adquirente/webhook" /var/log/nginx/access.log | tail -30');
