...
class SaqueInterfaceHelper
{
    ...
    public static function calcularInformacoesSaque($user, $valorSolicitado = null)
    {
        ...
        $adquirenteRef = Helper::adquirenteDefault($user->user_id, 'pix');
        ...
        if ($valorSolicitado !== null) {
            $taxasSolicitadas = TaxaSaqueHelper::calcularTaxaSaque($valorSolicitado, $setting, $user, true, false, $adquirenteRef);
        }
