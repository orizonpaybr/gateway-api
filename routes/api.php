...
Route::middleware(['verify.jwt', 'throttle:120,1'])->group(function () {
    ...
    Route::post('pix/generate-qr', [UserController::class, 'generatePixQR'])->middleware(['throttle.simpay.pix', 'throttle.paytler.pix', 'throttle.fyhub.pix', 'throttle.treeal.pix', 'throttle.fluxpayments.pix', 'throttle.paya55.pix']);
    ...
    Route::post('pix/withdraw-with-key', [PixKeyController::class, 'withdraw'])->middleware(['throttle.simpay.pix', 'throttle.paytler.pix', 'throttle.fyhub.pix', 'throttle.treeal.pix', 'throttle.fluxpayments.pix', 'throttle.paya55.pix']);
...
/* PIX */
Route::middleware(['check.token.secret', 'throttle.simpay.pix', 'throttle.paytler.pix', 'throttle.fyhub.pix', 'throttle.treeal.pix', 'throttle.fluxpayments.pix', 'throttle.paya55.pix', 'throttle:pix-in'])->post('wallet/deposit/payment', [DepositController::class, 'makeDeposit']);
Route::middleware(['check.token.secret', 'check.allowed.ip', 'throttle.simpay.pix', 'throttle.paytler.pix', 'throttle.fyhub.pix', 'throttle.treeal.pix', 'throttle.fluxpayments.pix', 'throttle.paya55.pix', 'throttle:pix-out'])->post('pixout', [SaqueController::class, 'makePayment']);
Route::middleware('throttle:status-check')->post('status', [DepositController::class, 'statusDeposito']);

/* PIX - conferir recebedor (decode copia-e-cola) */
Route::middleware(['check.token.secret', 'throttle:status-check'])->post('wallet/pix/decode', [DepositController::class, 'decodeQrCode']);
